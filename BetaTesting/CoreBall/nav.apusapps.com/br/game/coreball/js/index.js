                ...
                h.on("passed", function() {
                    i.switchStage(0, function() {
                        h.enabled = !1,
                            ...
                            // 2. åˆ†äº«æŽ¥å£
                            // 2.1 ç›‘å¬â€œåˆ†äº«ç»™æœ‹å‹â€ï¼ŒæŒ‰é’®ç‚¹å‡»ã€è‡ªå®šä¹‰åˆ†äº«å†…å®¹åŠåˆ†äº«ç»“æžœæŽ¥å£
                    })
                }),
...
levelProgressBarWidth = GlobalLevel * 80/60.0 + "px";
levelProgressBar.style.width = levelProgressBarWidth;

        function testGlobalFailNum() {
            if (GlobalFailNum == 3)
            {
                //alert('3');
